...
const DocsTemplate = () => {
    ...
    return (
        <div className="flex min-h-screen bg-sky-950 text-white">
            {/* Sidebar */}
            <aside className="w-64 border-r border-cyan-500 p-6  ">
            ...
            <main ref={mainRef} className="flex-1 p-8 h-[100vh] overflow-auto">
                <div className="mb-6">
                    <h1 className="mb-4 text-4xl font-bold">Deployment</h1>
                    <p className="text-zinc-400">Deploy my projects</p>
                </div>
                        ...
                        data?.map((x, i) => (
                            <section key={i}>
                                ...
                                <p className="mt-4 text-zinc-400">
                                    {x.title}
                                    <code className="rounded bg-sky-800 px-1.5 py-0.5 ml-2">{x.feature}</code>:
                                </p>
